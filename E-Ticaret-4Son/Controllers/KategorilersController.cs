...
namespace E_Ticaret_4Son.Controllers
{
    public class KategorilersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KategoriID,KategoriAdı")] Kategoriler kategoriler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KategoriID,KategoriAdı")] Kategoriler kategoriler)
        {
            if (ModelState.IsValid)
            {
